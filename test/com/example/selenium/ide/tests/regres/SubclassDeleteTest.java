...
public class SubclassDeleteTest {
	...
	public void setUp() {
		...
		driver.findElement(By.xpath("//*[@id='navigationbar']//a[@href = '/registrator/resourcetypes/show-res-types']")).click();
	...
	public void testConfirmMessageAppear() {
		...
		assertEquals(driver.findElement(By.xpath("//button[text() ='×']/following-sibling::div")).getText(),
	...
	public void testCancelDelettingByX() {
		...
		driver.findElement(By.xpath("//div/preceding-sibling::button[text() ='×']")).click();
